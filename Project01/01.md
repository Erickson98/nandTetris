...
CHIP DMux8Way {
   ...
   // DMux(in=out1 , sel=sel[1] , a=avsb , b=cvsd );
   // DMux(in=out2 , sel=sel[1] , a=evsf , b=gvsh );

    DMux4Way(in=in, sel=sel[1..2], a=avsb, b=cvsd, c=evsf, d=gvsh);
    DMux(in=avsb , sel=sel[0] , a=a , b=b );
    DMux(in=cvsd , sel=sel[0] , a=c , b=d );
    DMux(in=evsf , sel=sel[0] , a=e , b=f );
    DMux(in=gvsh , sel=sel[0] , a=g , b=h );
